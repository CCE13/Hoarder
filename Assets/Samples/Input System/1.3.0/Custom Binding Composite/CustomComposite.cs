...
// in the editor and [RuntimeInitializeOnLoadMethod] in the _player.
#if UNITY_EDITOR
[InitializeOnLoad]
#endif
...
// in this case refer to the binding composite parts by _name. Each such
// instance is replaced with the display _text for the corresponding
// part binding.
...
public class CustomComposite : InputBindingComposite<Vector2>
{
    ...
    // In the _player, [RuntimeInitializeOnLoadMethod] will make sure our
    ...
    private static void Initialize()
    {
        ...
        //
        // NOTE: We don't supply a _name for the composite here. The default logic
        //       will take the _name of the type ("CustomComposite" in our case)
        //       and snip off "Composite" if used as a suffix (which is the case
        //       for us) and then use that as the _name. So in our case, we are
